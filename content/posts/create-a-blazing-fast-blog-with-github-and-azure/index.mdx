...
> Disclaimer: This Guide will use preview features, [GitHub Codespaces](https://github.com/features/codespaces), that not everyone have access to yet, and [Azure Static Web App Service](https://azure.microsoft.com/en-us/services/app-service/static/) UPDATE: Azure Static Web app is now out of preview! 
...
[You can find part 2 here!](https://lukaslund.in/create-a-blazing-fast-blog-with-git-hub-and-azure-without-leaving-your-browser-part-2)
