...
This Guide assumes you have access to GitHub Codespaces, but you can can complete it in a local environment too.

>I started this project with the aim to develop a lightweight blog locally and host it as a Static Web App on Azure. While uploading the first iteration to my GitHub repository I noticed the Codespaces feature and got curious - can I fully replace my local environment with one in the cloud?

### Speed over convenience?
There are always trade offs to be made when selecting a technology for something. Wordpress and the like might offer a simple website and blog platform from a content creator’s standpoint, but falls behind in performance and security, and requires maintenance. Static websites and Jamstacks, on the other hand, are fast and secure, but require effort to update. It is however possible to make static websites as easy to use as traditional Wordpress blogs, by using GitHub and DevOps magic to automate content updates.
