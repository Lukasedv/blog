...
The random URL might not be very human-friendly, so connecting a domain name to your blog is probably of high priority. Domains can be acquired through a lot of different providers and this tutorial will not focus on how to purchase a domain, those instructions differ a bit bewteen registrar. 
